...
#%%
prefix = "sttc_"
M = pd.read_csv(data_processed + prefix + "male.csv", index_col="ecg_id")
F = pd.read_csv(data_processed + prefix + "female.csv", index_col="ecg_id")
...
pd.DataFrame(F).to_csv(data_processed + prefix + "femaleH.csv")
pd.DataFrame(M).to_csv(data_processed + prefix + "maleH.csv")
